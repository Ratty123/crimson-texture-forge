...
from crimson_texture_forge.core.archive import ArchiveEntry
from crimson_texture_forge.core.pipeline import build_compare_preview_pane_result, parse_dds
from crimson_texture_forge.core.replace_assistant import (
...
from crimson_texture_forge.core.realesrgan_ncnn import discover_realesrgan_ncnn_models
...
class ReplaceAssistantReviewDialog(QDialog):
    def __init__(self, texconv_path: Optional[Path], review_items: Sequence[ReplaceAssistantReviewItem], parent: Optional[QWidget] = None) -> None:
        ...
        queue_hint = QLabel("Review each rebuilt DDS against the edited source before shipping the package.")
...
class ReplaceAssistantTab(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self.package_title_edit = QLineEdit("Crimson Texture Forge Mod")
    ...
    def _load_settings(self) -> None:
        ...
        self.package_title_edit.setText(str(self.settings.value("replace_assistant/package_title", "Crimson Texture Forge Mod")))
    ...
    def _schedule_preview(self, item: ReplaceAssistantItem) -> None:
        ...
        self.preview_warning_label.setVisible(bool(item.warning))
        self.preview_warning_label.setText(item.warning)
    ...
    def _handle_preview_ready(self, request_id: int, payload: object) -> None:
        ...
        self.preview_warning_label.setVisible(bool(payload.warning_text))
        self.preview_warning_label.setText(payload.warning_text)
        self.preview_details_edit.setPlainText(payload.detail_text or "")
    ...
    def _cleanup_preview_refs(self) -> None:
        ...
        if hasattr(self, "pending_preview_item") and self.pending_preview_item is not None:
    ...
    def _current_build_options(self) -> ReplaceAssistantBuildOptions:
        ...
        return ReplaceAssistantBuildOptions(
            ...
            package_info=ModPackageInfo(
                title=self.package_title_edit.text().strip() or "Crimson Texture Forge Mod",
    ...
    def _handle_build_complete(self, payload: object) -> None:
        ...
        if summary.output_root is not None:
            ...
            if summary.review_items:
                self._open_review_dialog(summary.review_items)
        else:
            self.last_built_output_root = None
