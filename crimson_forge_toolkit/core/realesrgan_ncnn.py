...
from crimson_forge_toolkit.models import NormalizedConfig, TextureProcessingPlan
...
def run_realesrgan_ncnn_stage(
    ...
    *,
    ...
    for attempt_index, tile_size in enumerate(attempt_tiles, start=1):
        attempt_output_root = Path(tempfile.mkdtemp(prefix="crimson_forge_toolkit_ncnn_"))
